...
#export model
python3 tools/export_model.py -c output/rec/final_500_umv_trans_2/config.yml \
                              -o Global.pretrained_model=output/rec/final_500_umv_trans_2/best_accuracy \
                               Global.save_inference_dir=./inference/rec/final_500_umv_trans_2/best_accuracy
...
python3 tools/infer/predict_rec.py --rec_algorithm=CRNN\
                                   ...
                                   --use_srn_resize=True\
                                   --max_text_length=35\
                                   --rec_model_dir=inference/rec/final_500_umv_trans_2/best_accuracy\
                                   --rec_char_dict_path=ppocr/utils/ppocr_keys_v2.txt\
                                   --rec_save_path="inference/rec/final_500_umv_trans_2/best_accuracy/latest_predict_rec.txt"
#count error
...
python3 tools/infer_rec.py -c output/rec/final_500_umv_trans_2/config.yml\
                           -o Global.pretrained_model=output/rec/final_500_umv_trans_2/best_accuracy\
...
python3 tools/infer/predict_rec.py --rec_algorithm=CRNN\
                                   ...
                                   --use_srn_resize=True\
                                   --max_text_length=35\
                                   --rec_model_dir=inference/rec/final_500_umv_trans_2_9.8M/best_accuracy\
                                   --rec_char_dict_path=ppocr/utils/ppocr_keys_v2.txt\
                                   --rec_save_path="inference/rec/final_500_umv_trans_2_9.8M/best_accuracy/latest_predict_rec.txt"
